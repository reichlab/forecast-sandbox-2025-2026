...
- Main source: NHSN
- Supplementary sources: NSSP, ILINet, FluSurvNet
- SMH model filter: n/a (no SMH source)
- SMH output_type_id sample size (`smh_num_otid`): n/a (no SMH source)
- SMH otid sampling seed (`smh_otid_seed`): n/a

# To run locally without Docker

To test this out locally, run the following with this directory (`gbqr_4src`) as your
working directory.
...
This should result in a model output file under `../../model-output/UMass-gbqr_4src/`.

...
# load target data
target_data <- readr::read_csv(paste0("https://raw.githubusercontent.com/cdcepi/FluSight-forecast-hub/main/auxiliary-data/target-data-archive/target-hospital-admissions_", reference_date - 7, ".csv"))

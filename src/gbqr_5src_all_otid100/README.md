...
To test this out locally, run the following with this directory (`gbqr_5src_all_otid100`) as your
working directory.
...
This should result in a model output file under `../../model-output/UMass-gbqr_5src_all_otid100/`.

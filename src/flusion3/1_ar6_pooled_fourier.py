...
def main(reference_date: str, short_run: bool):
    """Generate flu predictions from AR6 pooled model with Fourier seasonality."""
    reference_date = datetime.date.fromisoformat(reference_date)

    model_config = SimpleNamespace(
        model_class = "sarix",
        model_name = "ar6_pooled_fourier",
        ...
        # AR parameters
        p = 6, P = 0, d = 0, D = 0, season_period = 1,

        # power transform applied to surveillance signals
        power_transform = "4rt",

        # theta and sigma are AR parameters
        # pooling: "none" = fit separately, "shared" = pool across locations

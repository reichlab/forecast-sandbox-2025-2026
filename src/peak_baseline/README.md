...
Conditional-climatology baseline (`idmodels.peak.PeakBaselineModel`).
...
This writes `../../model-output/UMass-peak_baseline/<reference_date>-UMass-peak_baseline.csv`. On macOS, LightGBM needs

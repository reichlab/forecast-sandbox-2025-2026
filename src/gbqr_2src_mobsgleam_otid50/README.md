...
To test this out locally, run the following with this directory (`gbqr_2src_mobsgleam_otid50`) as your
working directory.
...
This should result in a model output file under `../../model-output/UMass-gbqr_2src_mobsgleam_otid50/`.

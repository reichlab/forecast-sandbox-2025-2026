...
- SMH model filter: UT-ImmunoSEIRS
- SMH output_type_id sample size (`smh_num_otid`): 100
- SMH otid sampling seed (`smh_otid_seed`): 42

# To run locally without Docker

To test this out locally, run the following with this directory (`gbqr_2src_utseirs_otid100`) as your
working directory.
...
This should result in a model output file under `../../model-output/UMass-gbqr_2src_utseirs_otid100/`.

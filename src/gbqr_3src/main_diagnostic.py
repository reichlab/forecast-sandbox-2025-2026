"""
Diagnostic version of gbqr_3src main.py with artifact saving enabled.
...
def main(today_date: str, short_run: bool, artifact_dir: str):
    """Generate flu predictions from gbqr model with diagnostic outputs."""
    try:

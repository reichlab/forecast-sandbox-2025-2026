...
def main(today_date: str | None = None):
    """Generate flu predictions from AR(6) model with Fourier seasonality."""
    try:
    ...
    model_config = SimpleNamespace(
        model_class = "sarix",
        model_name = "AR6_fourier_d1_pooled",
        ...
        fourier_K = 2,  # Number of Fourier harmonic pairs for annual seasonality
